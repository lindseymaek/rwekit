...
Users are warned that the reported levels of the output terms are not changed to reflect the new reported levels of variables for which the inverse is reported. When verbose is set to TRUE, a warning reminder of this will be thrown any time the report.inverse argument is not NULL.
